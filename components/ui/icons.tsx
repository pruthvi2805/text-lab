...
export function JsonIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CaseIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function RegexIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function BinaryIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function HashIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function UuidIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function YamlIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M20 6h-4l-4 6 4 6h4" />
    </svg>
  );
}

export function MarkdownIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M18 12h-4m4 0l-2-2m2 2l-2 2" />
    </svg>
  );
}

export function HtmlIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ColorIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LoremIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
